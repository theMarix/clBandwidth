...
if __name__ == '__main__':
	...
	parser.add_option('-n', '--min-offset', type=int, metavar='BYTE', default=0, help='Minimum memory offset in elements')
	parser.add_option('-i', '--increment-offset', type=int, metavar='BYTE', default=1, help='Steps for memory offset in elemts')
